...
def main():
    ...
    for model_type in LOW_FIDELITY_MODEL_TYPES: 
        ...
        for num_particles in LOW_FIDELITY_NUM_PARTICLES_LIST:
            ...
            low_fidelity_state = np.load(f'{LOW_FIDELITY_LOAD_PATH}_{num_particles}_bootstrap/states.npz')
            ...
            low_fidelity_pars = np.load(f'{LOW_FIDELITY_LOAD_PATH}_{num_particles}_bootstrap/pars.npz')
